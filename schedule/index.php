 ...
 <body class="fix-header fix-sidebar card-no-border">
    ...
    <div id="main-wrapper">
            ...
            <div class="scroll-sidebar" >
                ...
                <nav class="sidebar-nav">
                    <ul id="sidebarnav">
                        ...
                        <li> <a class="waves-effect waves-dark" href="#"onclick="openPage('tabel-jadwal.php')" aria-expanded="false"><i class="fa fa-calendar"></i><span class="hide-menu">Schedule</span></a>
                        </li>
                        ...
                        <li> <a class="waves-effect waves-dark" href="#" onclick="openPage('store.php')" aria-expanded="false"><i class=" fa fa-shopping-cart"></i><span class="hide-menu">Store</span></a>
                        </li>
                        ...
                        <li style="size: -25px;"><a class="waves-effect waves-dark" href="main/login/logout.php" aria-expanded="false"><i class="fa fa-sign-out"></i><span class="hide-menu">logout</span></a></li>
        ...
        <!-- ============================================================== -->
            ...
            <!-- footer -->
            <!-- ============================================================== -->
            <footer class="footer text-center" style="margin-left: 250px;">© 2018 KFC Admin Page by PT Fastfood Indonesia</footer>
            <!-- ============================================================== -->
            <!-- End footer -->
 </html>
